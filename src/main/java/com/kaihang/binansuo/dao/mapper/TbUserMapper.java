...
public interface TbUserMapper {
    ...
    @Insert({
        ...
        "age, valid_ind, create_time, ",
        "modify_time)",
        "values (#{name,jdbcType=VARCHAR}, #{sex,jdbcType=VARCHAR}, ",
        "#{age,jdbcType=INTEGER}, #{validInd,jdbcType=INTEGER}, #{createTime,jdbcType=TIMESTAMP}, ",
    ...
    @Select({
        "select",
        "id, name, sex, age, valid_ind, create_time, modify_time",
        "from tb_user",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
